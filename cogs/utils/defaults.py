...
features = {
    ...
    "AUDIO_BITRATE_128_KBPS": "Bithastighet på stemmekanal 128 kbps",
    "AUDIO_BITRATE_256_KBPS": "Bithastighet på stemmekanal 256 kbps",
    "AUDIO_BITRATE_384_KBPS": "Bithastighet på stemmekanal 384 kbps",
    ...
    "MAX_FILE_SIZE_100_MB": "Maks filstørelse 100 MB",
    "MAX_FILE_SIZE_50_MB": "Maks filstørelse 50 MB",
    ...
    "SOUNDBOARD": "Lydbrett",
    "STAGE_CHANNEL_VIEWERS_150": "150 maks seere i scenekanal",
    "STAGE_CHANNEL_VIEWERS_300": "300 maks seere i scenekanal",
    "STAGE_CHANNEL_VIEWERS_50": "50 maks seere i scenekanal",
    ...
    "TIERLESS_BOOSTING": "Ustrukturert boosting",
    "VANITY_URL": "Egen URL",
    "VERIFIED": "Verifisert",
    "VIDEO_BITRATE_ENHANCED": "Forbedret bithastighet på video",
    "VIDEO_QUALITY_1080_60FPS": "Videokvalitet 1080p 60pbs",
    "VIDEO_QUALITY_720_60FPS": "Videokvalitet 720p 60pbs",
    "VIP_REGIONS": "VIP",
...
intents = {
    ...
    "guild_polls": "guild-spørreundersøkelser",
